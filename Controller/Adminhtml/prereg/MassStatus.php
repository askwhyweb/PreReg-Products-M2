...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('prereg');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('OrviSoft\PreReg\Model\Prereg')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('prereg/*/index');
    }
